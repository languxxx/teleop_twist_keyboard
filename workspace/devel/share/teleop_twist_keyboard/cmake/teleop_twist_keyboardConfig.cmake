...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/me131/teleop_twist_keyboard/workspace/src/teleop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/me131/teleop_twist_keyboard/workspace/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/me131/teleop_twist_keyboard/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'me131 <me131@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/me131/teleop_twist_keyboard/workspace/src/teleop_twist_keyboard/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/me131/teleop_twist_keyboard/workspace/devel/lib;/home/me131/teleop_twist_keyboard/workspace/devel/lib;/home/me131/barc/workspace/devel/lib;/opt/ros/kinetic/lib)
